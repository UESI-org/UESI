...
bool paging_map_range(page_directory_t *pd,
                      uint64_t virt_base,
                      uint64_t phys_base,
                      size_t num_pages,
                      uint64_t flags);
bool paging_unmap_range(page_directory_t *pd,
                        uint64_t virt_base,
                        size_t num_pages);
bool paging_map_region(page_directory_t *pd, memory_region_t *region);
bool paging_identity_map(page_directory_t *pd,
                         uint64_t phys_base,
                         size_t num_pages,
                         uint64_t flags);
bool paging_is_range_mapped(page_directory_t *pd,
                            uint64_t virt_base,
                            size_t num_pages);
...
bool paging_protect_range(page_directory_t *pd,
                          uint64_t virt_base,
                          size_t num_pages,
                          uint64_t flags);
