...
void
tty_putpixel(uint64_t x, uint64_t y, uint32_t color)
{
	tty_t *tty = tty_get();
...
uint32_t
tty_getpixel(uint64_t x, uint64_t y)
{
	tty_t *tty = tty_get();
...
void
tty_fill_rect(uint64_t x, uint64_t y, uint64_t w, uint64_t h, uint32_t color)
{
	tty_t *tty = tty_get();
