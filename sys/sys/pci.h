...
int pci_read_bar(uint8_t bus, uint8_t device, uint8_t function,
    uint8_t bar_num, pci_bar_t *bar);
uint32_t pci_bar_sizing(uint8_t bus, uint8_t device, uint8_t function,
    uint8_t bar_num);
...
void pci_set_command(uint8_t bus, uint8_t device, uint8_t function,
    uint16_t command);
...
int pci_msix_set_vector(pci_device_t *dev, uint16_t vector, uint64_t address,
    uint32_t data);
