...
#define AHCI_PCMD_MPSP          0x00080000  /* Mechanical Presence Switch Attached to Port */
...
#define AHCI_PCMD_APSTE         0x00800000  /* Automatic Partial to Slumber Transitions Enabled */
...
#define AHCI_PINT_ERROR_MASK    (AHCI_PINT_TFES | AHCI_PINT_HBFS | AHCI_PINT_HBDS | \
                                 AHCI_PINT_IFS | AHCI_PINT_INFS | AHCI_PINT_OFS | \
                                 AHCI_PINT_IPMS | AHCI_PINT_UFS)

#define AHCI_SSTS_DET           0x0000000F  /* Device Detection */
#define AHCI_SSTS_DET_NONE      0x00000000  /* No device detected */
#define AHCI_SSTS_DET_PRESENT   0x00000001  /* Device detected, no PHY communication */
#define AHCI_SSTS_DET_ESTAB     0x00000003  /* Device detected and PHY communication established */
...
#define AHCI_SCTL_DET_NONE      0x00000000  /* No device detection or initialization */
...
#define AHCI_CMD_TABLE_SIZE_FULL (AHCI_CMD_TABLE_SIZE + (AHCI_PRDT_MAX_ENTRIES * sizeof(ahci_prdt_entry_t)))
...
typedef struct ahci_port {
    ...
    ahci_cmd_table_t *cmd_tables[AHCI_MAX_CMDS]; /* Command tables (virtual) */
