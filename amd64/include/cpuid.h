...
static inline bool
cpuid_has_pclmulqdq(void)
{
	return cpuid_has_feature(CPUIDECX_PCLMUL);
}

static inline bool
cpuid_has_monitor(void)
{
...
static inline bool
cpuid_has_rdrand(void)
{
	return cpuid_has_feature(CPUIDECX_RDRAND);
}

static inline bool
cpuid_has_hypervisor(void)
{
 ...
 */
static inline bool
cpuid_has_fsgsbase(void)
{
	return cpuid_has_ext7_feature(SEFF0EBX_FSGSBASE);
}

static inline bool
cpuid_has_tsc_adjust(void)
{
...
static inline bool
cpuid_has_avx512_ifma(void)
{
	return cpuid_has_ext7_feature(SEFF0EBX_AVX512IFMA);
}

static inline bool
cpuid_has_clflushopt(void)
{
