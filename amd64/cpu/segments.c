...
void setgate(struct gate_descriptor *gd, void *func, int ist, 
...
void set_sys_segment(struct sys_segment_descriptor *sd, void *base, 
                     uint64_t limit, int type, int dpl, int gran) {
...
void set_mem_segment(struct mem_segment_descriptor *sd, void *base,
                     uint64_t limit, int type, int dpl, int gran,
                     int def32, int is_long) {
    uint64_t addr = (uint64_t)base;
