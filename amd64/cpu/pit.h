...
#define PIT_CMD_COUNTER0_RATE   (PIT_SELECT_CHANNEL0 | PIT_ACCESS_LOHI | PIT_MODE_2 | PIT_BINARY)
#define PIT_CMD_COUNTER0_ONESHOT (PIT_SELECT_CHANNEL0 | PIT_ACCESS_LOHI | PIT_MODE_0 | PIT_BINARY)
#define PIT_CMD_COUNTER0_SQUARE  (PIT_SELECT_CHANNEL0 | PIT_ACCESS_LOHI | PIT_MODE_3 | PIT_BINARY)
